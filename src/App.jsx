  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center from-[#f5fdf3] to-[#eff3ee] px-4 relative">
      ...
      <div className="flex justify-center space-x-6 mt-8">
        ...
        <FaInstagram size={22} className="cursor-pointer hover:text-[#91C730]" />
        <PiLinkedinLogoBold size={22} className="cursor-pointer hover:text-[#91C730]" />
        <TiSocialFacebookCircular size={26} className="cursor-pointer hover:text-[#91C730]" />
      </div>
